...
<body>
    ...
    <div class="container my-4">
        <div class="card mb-3">
            <div class="row g-0">
                <div class="col-md-4">
                    <img src="p-images/image1.jpg" style="height:200px;" class="img-fluid rounded-start" alt="test page">
                </div>
                <div class="col-md-8">
                    <div class="card-body">
        ...
        <div class="row mx-0">
            <div class="col-lg-3 col-md-4 col-sm-6  col-xs-12">
                <div class="card">
                    <img src="p-images/images3.jpeg" class="card-img-top" alt="tech image">
                    <div class="card-body">
                        <h5 class="card-title">New laptop</h5>
